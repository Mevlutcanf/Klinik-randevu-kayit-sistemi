    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_QuickAppointments", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DoktorNotu = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "İç Hastalıkları", "Dahiliye" },
                    { 2, "Kalp ve Damar Hastalıkları", "Kardiyoloji" },
                    { 3, "Sinir Sistemi Hastalıkları", "Nöroloji" },
                    { 4, "Kas ve İskelet Sistemi", "Ortopedi" },
                    { 5, "Göz ve Görme Bozuklukları", "Göz Hastalıkları" }
                });
